...
def descargar_archivo2():
    ...
    directory4 = '/var/py/volunclima/scripts/goes-16/Output/8/PERU/'
    directory5 = '/var/py/volunclima/scripts/goes-16/Output/8/VENEZUELA/'
    directory6 = '/var/py/volunclima/scripts/goes-16/Output/8/COLOMBIA/'
    directory7 = '/var/py/volunclima/scripts/goes-16/Output/8/CHILE/'
    directory8 = '/var/py/volunclima/scripts/goes-16/Output/8/BOLIVIA/'
...
def generar_png_CH8():
  ...
  for path in paths:
    ...
    for indice,pais in enumerate(paises):
      ...
      plt.savefig('/var/py/volunclima/scripts/goes-16/Output/8/'+pais +'/CMIPF_Band_8_'+date+'-'+time+'_'+pais+'.png', dpi=DPI, bbox_inches='tight', pad_inches=0)  
...
def generar_gif():
  ...
  for indice,directorio_actual in enumerate(directorios):
    ...
    if(indice==0):
      ...
      output_file = directorio_actual+'band_08_ecuador.gif'
    elif(indice==1):
      # Especificar el nombre del archivo de salida del GIF
      #output_file = directory+'band_02_'+rangoi+'_'+rangof+'_guayaquil.gif'
      output_file = directorio_actual+'band_08_guayaquil.gif'
    elif(indice==2):
      #output_file = directory+'band_02_'+rangoi+'_'+rangof+'_galapagos.gif'
      output_file = directorio_actual+'band_08_galapagos.gif'
    elif(indice==3):
      #output_file = directory+'band_02_'+rangoi+'_'+rangof+'_galapagos.gif'
      output_file = directorio_actual+'band_08_peru.gif'
    elif(indice==4):
      #output_file = directory+'band_02_'+rangoi+'_'+rangof+'_galapagos.gif'
      output_file = directorio_actual+'band_08_venezuela.gif'
    elif(indice==5):
      #output_file = directory+'band_02_'+rangoi+'_'+rangof+'_galapagos.gif'
      output_file = directorio_actual+'band_08_colombia.gif'
    elif(indice==6):
      #output_file = directory+'band_02_'+rangoi+'_'+rangof+'_galapagos.gif'
      output_file = directorio_actual+'band_08_chile.gif'
    else:
      #output_file = directory+'band_02_'+rangoi+'_'+rangof+'_galapagos.gif'
      output_file = directorio_actual+'band_08_bolivia.gif'
    frame_duration = 5
